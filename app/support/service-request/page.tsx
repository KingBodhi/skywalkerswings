          ...
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="card p-6">
                ...
                <a href="mailto:support@skywalker.com" className="flex items-center gap-4 p-4 bg-neutral-50 rounded-xl hover:bg-neutral-100 transition-colors">
                  ...
                  <div>
                    <div className="font-bold text-primary-600">support@skywalker.com</div>
